...
int SendPointMessage(igtl::Socket * socket, igtl::PointElement::Pointer pointElement)
{
	igtlFloat32 pos[3];
	...
	if (r == 0)
	{
		std::cerr << "Nie uda³o siê wys³aæ punktów do klienta!" << std::endl;
	}
...
int ReceivePoint(igtl::Socket * socket, igtl::MessageHeader * header)
{
	...
	if (c & igtl::MessageHeader::UNPACK_BODY) // if CRC check is OK
	{
		...
		for (int i = 0; i < nElements; i++)
		{
			...
			SendPointMessage(socket, pointElement);
		}
		socket->CloseSocket();
	}
